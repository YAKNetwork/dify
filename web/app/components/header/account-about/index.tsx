        ...
        <div>
          ...
          <div className='mb-4 text-center text-xs font-normal text-gray-700'>
            ...
            <div className='text-[#1C64F2]'>
              {
                IS_CE_EDITION
                  ? <Link href={'https://github.com/YAKNetwork/dify/blob/main/LICENSE'} target='_blank' rel='noopener noreferrer'>Open Source License</Link>
                  : <>
        ...
        <div className='flex justify-between items-center'>
          ...
          <div className='flex items-center'>
            <Link
              ...
              href={'https://github.com/YAKNetwork/dify/releases'}
